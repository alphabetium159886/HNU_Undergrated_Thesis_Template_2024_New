...
\newcommand\prechaptername{\textbf{第}}
\newcommand\postchaptername{\textbf{章}}
...
%%%%%%%%%%%%% Contents %%%%%%%%%%%%%%%%%
\renewcommand{\contentsname}{\textbf{目}\qquad \textbf{录}}
...
\renewcommand{\listfigurename}{\textbf{插图索引}}
\setcounter{lofdepth}{1}
\renewcommand{\listtablename}{\textbf{附表索引}}
...
\def\makecover{
	...
	\begin{center}
		...
		\begin{overpic}[scale=0.3]{figures/Hnulogo}
			\put(12,75){\li\yihao HUNAN UNIVERSITY}
			\put(-15,40){\song\biaoti \@heading}
		\end{overpic}
		...
		\setlength{\@title@width}{6.5cm}
		{
			...
			\begin{spacing}{2.1}
				\xiaoer\hei{\textbf{论文题目：}} \xiaoer \hei\underline{\makebox[\@title@width][l]{激光驱动的磁场重联的}} \\
				\xiaoer\hei{\qquad\qquad\quad} \xiaoer \hei\underline{\makebox[\@title@width][c]{数值模拟研究}} \\%这是当你的论文题目太长需要换行的时候才用这个
				...
				\xiaosi\song{\makebox[\@title@width][l]{\qquad \qquad \qquad 2024 年 5 月 21 日}} \\
				%\end{tabular}
			\end{spacing}
		}
	\end{center}
...
\end{titlepage}
	...
	\addcontentsline{toc}{chapter}{\textbf{学位论文原创性声明和学位论文版权使用授权书}}{
		\setcounter{page}{1}
		\qquad\\
	...
	\addcontentsline{toc}{chapter}{\textbf{摘~~~~要}}
	\chapter*{\centering\xiaoer\ \textbf{摘}\qquad \textbf{要}}
	\song\defaultfont
	\@cabstract
	\vspace{\baselineskip}
	...
	\noindent
	{\hei\xiaosi \textbf{关键词：} \@ckeywords}
